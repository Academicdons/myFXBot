...
def thread_orders(stop_event, data, trading_data):
    ...
    while not stop_event.wait(10):
        ...
        if data["RSI"][0] > RSI_BUY_THRESHOLD and cur_time > last_operation_time + trading_data[
            "time_period"] * CANDLES_BETWEEN_OPERATIONS:  # Open buy
            last_operation_time = cur_time
            open_position(trading_data["market"], trading_data["lotage"], "buy")
        elif data["RSI"][0] < RSI_SELL_THRESHOLD and cur_time > last_operation_time + trading_data[
